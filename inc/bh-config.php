...
define("DB_USER", "blohaute_web"); 			// The database username. 
define("DB_PASSWORD", "U8h8taXF8pHMTj9bjEs58fhX"); 	// The database password. 
define("DB_DATABASE", "blohaute_new");             // The database name.
