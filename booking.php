<div class="overlay-wrapper">
	...
	<div class="vertical-align-wrapper center modal-wrapper">
		<form id="booking-form" action="inc/submitBooking.php" method="POST" class="vertical-center modal-content">
			...
			<fieldset>
				...
				<div class="grid clear">
					<div class="col-1"><input type="email" name="email" id="email" placeholder="email address"></div>
				</div>
			...
			<fieldset>
				...
				<button type="button" class="btn-booking-back">Back</button>
				<button type="submit" class="btn-booking-next">Book</button>
			</fieldset>
		</form>
	</div>
</div>